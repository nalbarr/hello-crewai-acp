...
@server.agent(metadata=Metadata(ui={"type":"hands-off", "user_greeting": "Ask your health question"}))
...
@server.agent(metadata=Metadata(ui={"type":"hands-off", "user_greeting": "Find a doctor, pass your query and state!"}))
